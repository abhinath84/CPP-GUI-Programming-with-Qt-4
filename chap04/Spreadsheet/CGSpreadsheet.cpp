...
bool CGSpreadsheet::writeFile(const QString &fileName)
{
    QFile file(fileName);
...
bool CGSpreadsheet::readFile(const QString &fileName)
{
    QFile file(fileName);
...
void CGSpreadsheet::cut()
{
    copy();
    del();
}

void CGSpreadsheet::copy()
{
    QString str;
...
QTableWidgetSelectionRange CGSpreadsheet::selectedRange() const
{
...
void CGSpreadsheet::del()
{
    foreach (QTableWidgetItem *item, selectedItems())
        delete item;
}

void CGSpreadsheet::selectCurrentRow()
{
    selectRow(currentRow());
}
void CGSpreadsheet::selectCurrentColumn()
{
    selectColumn(currentColumn());
}

void CGSpreadsheet::findNext(const QString &str, Qt::CaseSensitivity cs)
{
    int row = currentRow();
...
void CGSpreadsheet::findPrevious(const QString &str, Qt::CaseSensitivity cs)
{
    int row = currentRow();
    int column = currentColumn() - 1;
    while (row >= 0)
